...
var offset : Vector3 = Vector3.up;    // Units in world space to offset; 1 unit above object by default
var clampToScreen : boolean = false;  // If true, label will be visible even if object is off screen
var clampBorderSize : float = .05;  // How much viewport space to leave at the borders when a label is being clamped
var useMainCamera : boolean = true;   // Use the camera tagged MainCamera
