...
public class Detonator : MonoBehaviour {
	...
	public delegate string Function(GameObject gameObject);
	...
	*/
	...
	public static Material DefaultFireballAMaterial()
	{
        ...
        defaultFireballAMaterial = new Material(Shader.Find("Mobile/Particles/Additive"));
	...
	public static Material DefaultFireballBMaterial()
	{
        ...
        defaultFireballBMaterial =  new Material(Shader.Find("Mobile/Particles/Additive"));
	...
	public static Material DefaultSmokeAMaterial()
	{
        ...
        defaultSmokeAMaterial = new Material(Shader.Find("Mobile/Particles/Alpha Blended"));
	...
	public static Material DefaultSmokeBMaterial()
	{
        ...
        defaultSmokeBMaterial = new Material(Shader.Find("Mobile/Particles/Alpha Blended"));
	...
	public static Material DefaultSparksMaterial()
	{
        ...
        defaultSparksMaterial = new Material(Shader.Find("Mobile/Particles/Additive"));
	...
	{	
        ...
        defaultShockwaveMaterial = new Material(Shader.Find("Mobile/Particles/Additive"));
	...
	public static Material DefaultGlowMaterial()
	{
        ...
        defaultGlowMaterial = new Material(Shader.Find("Mobile/Particles/Additive"));
