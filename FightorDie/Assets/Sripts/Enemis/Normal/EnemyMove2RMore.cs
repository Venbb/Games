...
public class EnemyMove2RMore : MonoBehaviour {
            ...
            switch (animationState)
            {
                case 0:
                    ...
                    animationState = 1;
                        ...
                        moveUnit = new Vector2(1.875f * moveDistance / moveTime, 0.15f * moveDistance / moveTime);
                        scaleRatio = 7.5f / 70f;
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            animationTest.AnimationName = "dead_after_skill_L";
            enemyState = 4;
            Destroy(m_collider);
        }
    }
