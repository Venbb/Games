...
public class EnemyMove2L : MonoBehaviour {
        ...
        if (attackTime < 0)
        {
            ...
            switch (animationState)
            {
                case 0:
                    ...
                    if (attackTime == 1)
                    {
                        moveUnit = new Vector2(-1.6f * moveDistance / moveTime, 0.05f * moveDistance / moveTime);
                        scaleRatio = 9f / 82f;
                    }
                    else
                    {
                        moveUnit = new Vector2(-1.6f * moveDistance / moveTime, 0.15f * moveDistance / moveTime);
                        scaleRatio = 9f / 91f;
                    }
                    break;
                case 1:
