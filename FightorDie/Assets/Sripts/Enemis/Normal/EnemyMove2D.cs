...
public class EnemyMove2D : MonoBehaviour {
    ...
    void move()
    {
        if (attackTime < 0)
        {
            animationTest.state.SetAnimation(1, "attack", false);
            ...
            //switch (animationState)
            {
                //case 0:
                    ...
                    if (attackTime == 1)
                    {
                        moveUnit = new Vector2(0.95f * moveDistance / moveTime, -1.4f * moveDistance / moveTime);
                        scaleRatio = 15f / 70f;
                    }
                    else
                    {
                        moveUnit = new Vector2(-1.1f * moveDistance / moveTime, -1.2f * moveDistance / moveTime);
                        scaleRatio = 15f / 85f;
                    }
                //    break;
                //case 1:
