        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                ...
                if (valuesX.isExpanded)
                {
                    ...
                    EditorGUI.DrawRect(valXRB, new Color32(255, 255, 0, 100));
                }
                ...
                {
                    EditorGUI.DrawRect(valYR, new Color32(255, 0, 255, 100));
                }
                ...
                {
                    EditorGUI.DrawRect(valZR, new Color32(0, 255, 255, 100));
                }
                ...
                if (subValsToOpen != null)
                {
                    ...
                    if (valuesX.isExpanded)
                    {
                        EditorGUI.DrawRect(boxR1, new Color32(255, 255, 0, 100));
                    }
                    else if (valuesY.isExpanded)
                    {
                        EditorGUI.DrawRect(boxR1, new Color32(255, 0, 255, 100));
                    }
                    else if (valuesZ.isExpanded)
                    {
                        EditorGUI.DrawRect(boxR1, new Color32(0, 255, 255, 100));
                    }
                    else
                    {
                    ...
                    var valSZR = valR;
                    var valSDR = valR;
                    valSXR.width = valSYR.width = valSZR.width = valSDR.width = valR.width / 4;
                    valSYR.x = valSYR.x + valSXR.width;
                    valSZR.x = valSZR.x + valSXR.width + valSYR.width;
                    valSDR.x = valSDR.x + valSXR.width + valSYR.width + valSZR.width;
                    ...
                    var subValuesDef = subValsToOpen.FindPropertyRelative("def");
                    ...
                    var valSDRF = valSDR;
                    valSDRF.x = valSDRF.x + 30f;
                    valSDRF.width = valSDRF.width - 30f;
                    EditorGUI.LabelField(valSDR,"Def");
                    subValuesDef.floatValue = EditorGUI.FloatField(valSDRF, subValuesDef.floatValue);
